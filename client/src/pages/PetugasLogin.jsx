...
const PetugasLogin = () => {
  ...
  function handleSubmit(event) {
    ...
    axios.post('http://localhost:8081/petugas-login/', { user, password })
      .then(res => {
        console.log(res);
      ...
      <div className="w-full h-full flex justify-center items-center gap-5 md:w-4/5">
        ...
        <div className="w-full h-4/5 flex flex-col justify-center items-center max-w-sm md:max-w-md md:w-1/2">
          <div className="flex flex-col items-center gap-3">
            ...
            <h1 className="text-main-orange font-bold text-xl">Masuk sebagai petugas</h1>
          </div>
