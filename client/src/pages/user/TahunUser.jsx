                    ...
                    $(tableRef.current).DataTable({
                        ...
                        createdRow: function (row, data, dataIndex) {
                            ...
                            const statusCell = $('td:eq(3)', row); // Change 4 to the correct index of the "Status" column
                                ...
                                statusCell.html(`<a href="/iuran-user/${bulan}/${tahun}"><span class="bg-[#F9E3D0] text-[#FF9130] px-4 py-1 rounded-full" style="width: 120px; display: inline-block;">Lihat Detail</span></a>`);
                            },
                    });
